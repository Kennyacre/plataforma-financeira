    ...
    try {
        ...
        data.usuarios.forEach(u => {
            try {
                ...
                if (u.username && u.username.toLowerCase() !== 'admin') {
                    acoes = `
                        <div style="display: flex; gap: 8px; justify-content: flex-end;">
                            <button onclick="abrirModalEdicao(${u.id})" title="Editar Usuário" class="btn-block-small" style="color: #3b82f6;">
                ...
                const premiumBadge = u.is_premium ? '<span class="material-symbols-rounded" style="color: #f59e0b; font-size: 14px; vertical-align: middle; margin-left: 5px;" title="Cliente Premium">stars</span>' : '';
