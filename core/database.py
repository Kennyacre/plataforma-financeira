...
def startup_db():
    ...
    try:
        ...
        check_and_add_column(cur, 'usuarios', 'pix_chave', "VARCHAR(255)")
        check_and_add_column(cur, 'usuarios', 'pix_titular', "VARCHAR(255)")
        check_and_add_column(cur, 'usuarios', 'pix_banco', "VARCHAR(255)")
        check_and_add_column(cur, 'usuarios', 'solicitacao_renovacao', "BOOLEAN DEFAULT FALSE")
